    ...
    <div class="container-fluid">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Failed Appointment Details</h3>
            </div>
            <div class="card-body">
                <form method="POST" action="{!! url('/appointment/edit_failed/update/'.$appointment_data->id) !!}">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Comment</label>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <!-- <input type="textarea" name="type_exam" class="form-control" /> -->
                                    <textarea name="comment_exam" rows="4" cols="50"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
